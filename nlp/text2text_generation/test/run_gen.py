...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, default='advertisegen', help='The name of the dataset to load.')
    ...
    parser.add_argument('--save_dir', type=str, default='./table-log/checkpoints', help='The directory where the checkpoints will be saved.')
    ...
    parser.add_argument('--max_dec_len', type=int, default=128, help='The maximum sequence length of decoding.')
    ...
    parser.add_argument("--do_train", type=bool, default=True, help="Whether to train the model.")
#    parser.add_argument("--do_predict", action='store_true', help="Whether to eval and predict.")
    parser.add_argument("--do_predict", type=bool, default=True, help="Whether to train the model.")
